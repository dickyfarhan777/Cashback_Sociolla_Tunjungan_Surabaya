...
public class RegisterTest {
    ...
    public void admin_login_web_sociolla_cashback_lagi() {
        loginPage.loginAdmin("admintiara2", "a");
        extentTest.log(LogStatus.PASS, "Admin akses link web cashback lagi");
    }
    ...
    public void input_rrn_dengan_rrn_yang_sudah_terdaftar() {
        registerPage.setAngkaRRN("5123125123");
    ...
    public void menampilkan_alert_sukses() {
        ...
        Assert.assertEquals(alertMessage, "Error saving data");
        driver.switchTo().alert().accept();

        extentTest.log(LogStatus.PASS, "Menampilkan alert sukses");
    }

    @And("Akses menu link dashboard")
    public void akses_menu_link_dashboard() {
        registerPage.setLinkMenuDashboard();
        extentTest.log(LogStatus.PASS, "Akses menu link dashboard");
    }

    @Then("Menampilkan halaman home")
    public void menampilkan_halaman_home() {
        Assert.assertEquals(registerPage.getTxtLinkDashboard(), "Selamat datang, admintiara2");
    ...
    public void input_nama_nasabah_dengan_pangkat() {
        registerPage.setInputCustomerName("dikyasad^");
        extentTest.log(LogStatus.PASS, "Input Nama Lengkap Nasabah Dengan karakter ^");
    }
    @And("Input Nama Lengkap Nasabah Dengan karakter *")
    public void input_nama_nasabah_dengan_bintang() {
        registerPage.setInputCustomerName("dikyyy*");
        extentTest.log(LogStatus.PASS, "Input Nama Lengkap Nasabah Dengan karakter *");
    }
    @And("Input Nama Lengkap Nasabah Dengan karakter -")
    public void input_nama_nasabah_dengan_minus() {
        registerPage.setInputCustomerName("dikywfw-");
        extentTest.log(LogStatus.PASS, "Input Nama Lengkap Nasabah Dengan karakter -");
    }

    @And("Input Soco Id dengan menggunakan Karakter #")
    public void input_socoid_dengan_tanda_pagar() {
        registerPage.setInputSocoId("5555555 #");
        extentTest.log(LogStatus.PASS, "Input Soco Id dengan menggunakan Karakter #");
    }
    ...
    public void input_socoid_dengan_tanda_lbhkkecil_lbhbesar() {
        registerPage.setInputSocoId(faker.bothify("########<>'\""));
        extentTest.log(LogStatus.PASS, "Input Soco Id dengan menambahkan < > kutip satu kutip dua");
    }
    ...
    public void menampilkan_alert_please_fill_out_this_field() {
        DriverSingleton.delay(3);
        Assert.assertEquals(registerPage.getTxtRequiredSocoId(), "true");
    ...
    public void menampilkan_nama_merchant_alert_please_fill_out_this_field() {
        DriverSingleton.delay(3);
        Assert.assertEquals(registerPage.getTxtRequiredNamaMerchant(), "true");
