...
public class RegisterTest {
    ...
    public void and_input_nomor_hp_yang_terdaftar_di_bca_dengan_benar2() {
        registerPage.setInputNoHandphone("");
        extentTest.log(LogStatus.PASS, "Input Nomor Hp Yang Terdaftar Di Bca Dengan Benar1");
    }

    @And("Input Nomor Rekening Bca Dengan Benar1")
    public void input_nomor_rekening_bca_dengan_benar1() {
        registerPage.setInputNoRekening("");
        extentTest.log(LogStatus.PASS, "Input Nomor Rekening Bca Dengan Benar1");
    }

    @And("Input Rrn Dengan Benar1")
    public void input_rrn_dengan_benar1() {
        registerPage.setAngkaRRN("");
        extentTest.log(LogStatus.PASS, "nput Rrn Dengan Benar1");
    }

    @And("Input Soco Id dengan benar1")
    public void input_soco_id_dengan_benar1() {
        registerPage.setInputSocoId("");
        extentTest.log(LogStatus.PASS, "Input Soco Id dengan benar1");
    }
    ...
    public void input_nomor_rekening_bca_dengan_benar2() {
        registerPage.setInputNoRekening("");
        extentTest.log(LogStatus.PASS, "Input Nomor Rekening Bca Dengan Benar2");
    }

    @And("Input Rrn Dengan Benar2")
    public void input_rrn_dengan_benar2() {
        registerPage.setAngkaRRN("");
        extentTest.log(LogStatus.PASS, "Input Rrn Dengan Benar2");
    }
